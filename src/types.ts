...
export type CliCapabilityTier = "full" | "compatible";
export type CliCapabilities = {
  tier: CliCapabilityTier;
  ...
  supportsCodexConfigSync: boolean;
};
...
export type AppSettings = {
  ...
  codexShellToolEnabled: boolean;
  codexShellSnapshotEnabled: boolean;
  codexApplyPatchFreeformEnabled: boolean;
  codexExecPolicyEnabled: boolean;
  codexSmartApprovalsEnabled: boolean;
  codexRemoteCompactionEnabled: boolean;
  codexExperimentalWindowsSandboxEnabled: boolean;
  codexElevatedWindowsSandboxEnabled: boolean;
  codexModel: string | null;
  codexModelProvider: string | null;
  codexModelReasoningEffort: "minimal" | "low" | "medium" | "high";
  codexApprovalPolicy: "untrusted" | "on-failure" | "on-request" | "never";
  codexSandboxMode: "read-only" | "workspace-write" | "danger-full-access";
  codexCheckForUpdates: boolean;
  codexWebSearch: "cached" | "live";
  codexCliAuthCredentialsStore: "file" | "keyring" | "auto";
  codexPreferredAuthMethod: string | null;
